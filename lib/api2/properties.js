...
function create (env, ctx) {
  ...
  // Remote SugarPixel alarm (lib/server/pixelalarm.js): answers with {} or a
  // minimal synthetic bgnow for the configured subject; a no-op otherwise.
  if (ctx.pixelalarm) {
    properties.use(ctx.pixelalarm.interceptProperties);
  }
